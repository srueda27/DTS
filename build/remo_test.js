// Constants
const myPriceOptions = [10, 20, 30, 40];
const friendPriceOptions = [15, 25, 35, 45];
const myTotalVariableCost = 5;
const friendTotalVariableCost = 7;
const myTotalFixedCost = 100;
const friendTotalFixedCost = 120;
const totalHoursWorkedPerMonth = 100;
/**
 ...
 */
function checkPriceRange(prices, min, max) {
 ...
 */
function calculateMarketSharesForBoth(myPrice, friendPrice) {
 ...
 */
function calculateProfitsForBoth() {
    const results = [];
 ...
 */
function determineNashEquilibrium(profits) {
 ...
 */
function determineOptimalNash(nashEquilibrium) {
