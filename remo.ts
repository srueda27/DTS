...
function cleanStudentData(student_data: student_data) {
  ...
  if (!student_data.first_name) missing_data += 'First name field is empty. '

  student_data.last_name = student_data.last_name.trim()
  if (!student_data.last_name) missing_data += 'Last name field is empty. '
  ...
  if (missing_data) student_data.missing_data = missing_data.trim()
